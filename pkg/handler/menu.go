...
func GetMenu() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occure  while fetching the menu"})
		}
...
func UpdateMenu() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if menu.Start_Date != nil && menu.End_Date!= nil {
			...
			result, updateErr := menuCollection.UpdateOne(ctx, filter,bson.D{{"$set", updateObj}}, &opt)
			if updateErr!= nil {
