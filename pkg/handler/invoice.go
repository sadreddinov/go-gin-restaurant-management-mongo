...
func GetInvoices() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occures while listing invoice items"})
			return
		}
...
func GetInvoice() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occures while fetching invoice"})
		}
...
func CreateInvoice() gin.HandlerFunc {
	return func(c*gin.Context) {
		...
		valitionErr := validate.Struct(invoice)
		if valitionErr!= nil {
			c.JSON(http.StatusBadRequest, gin.H{"error": valitionErr})
			return
		}
